...
typedef LEEAlertConfigModel * _Nonnull (^LEEConfigToStringAndColorAndBlock)(NSString *str ,UIColor *color, void (^)(void));
...
typedef LEEAlertConfigModel * _Nonnull (^LEEConfigToConfigTextView)(void(^)(UITextView * _Nonnull textView));
